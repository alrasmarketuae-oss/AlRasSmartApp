...
export function IconGrid({ className = 'h-5 w-5' }: IconProps) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}>
      <path strokeLinecap="round" d="M4 4h7v7H4zM13 4h7v7h-7zM4 13h7v7H4zM13 13h7v7h-7z" />
    </svg>
  )
}
...
export function IconUsers({ className = 'h-5 w-5' }: IconProps) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M15 19c-4 0-7-2-7-5s3-5 7-5 7 2 7 5-3 5-7 5Zm0 0v2M9 12a3 3 0 1 0 0-6 3 3 0 0 0 0 6Zm8 7a3 3 0 1 0 0-6" />
    </svg>
  )
}

export function IconAds({ className = 'h-5 w-5' }: IconProps) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}>
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
        d="M11 5 6 9H4a1 1 0 0 0-1 1v4a1 1 0 0 0 1 1h2l5 4V5Zm0 0v14m5.5-9.5a4.5 4.5 0 0 1 0 7m2.5-9.5a7.5 7.5 0 0 1 0 11"
      />
    </svg>
  )
}
...
export function IconCategories({ className = 'h-5 w-5' }: IconProps) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}>
      <path
        strokeLinecap="round"
...
export function IconBanner({ className = 'h-5 w-5' }: IconProps) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}>
      ...
      <path strokeLinecap="round" strokeLinejoin="round" d="M4 9h16M8 13h8M8 16h5" />
    </svg>
  )
}

export function IconShipping({ className = 'h-5 w-5' }: IconProps) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M8 17h8M5 11h14l-1-4H6l-1 4ZM6 17a2 2 0 1 0 0 4 2 2 0 0 0 0-4Zm12 0a2 2 0 1 0 0 4 2 2 0 0 0 0-4Z" />
    </svg>
  )
}
...
export function IconReply({ className = 'h-5 w-5' }: IconProps) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}>
...
export function IconForward({ className = 'h-5 w-5' }: IconProps) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}>
