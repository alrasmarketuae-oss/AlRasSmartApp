...
/**
 * Retail ad detail — same row structure as WholesaleAdDetailView.
 */
export default function OffersAdDetailView({
  product,
  lookups,
  backToListPath,
  isSaving,
  ...
  const offerDurationLabel = product.offerDuration?.trim() || '—'
      ...
      <div className="space-y-2 px-3 py-2.5 text-start">
        ...
        <div className="space-y-1.5 border-t pt-2 text-xs" style={{ borderColor: C.border }}>
          ...
          <p className="flex items-center gap-1.5 break-all">
            ...
            <MailtoEmailLink email={product.ownerEmail} className="text-xs font-normal" />
          </p>
  ...
  return (
    <div className="offers-ad-fit origin-top space-y-3.5">
      {/* Header */}
          ...
          <div className="grid gap-4 p-4 sm:grid-cols-[170px_minmax(0,1fr)]">
            ...
            <div className="min-w-0 text-start">
              ...
              <div className="mt-3 grid gap-x-3 gap-y-2.5 sm:grid-cols-2 lg:grid-cols-3">
                <Meta icon={I.money} label={t('ads.price')} value={priceWithUnit} />
                <Meta icon={I.package} label={t('ads.quantity')} value={quantityLabel} />
                ...
                <Meta icon={I.calendar} label={t('ads.offerDuration')} value={offerDurationLabel} />
              ...
              <div className="grid gap-3 lg:grid-cols-[minmax(0,1.5fr)_minmax(150px,0.85fr)]">
                <div className="grid grid-cols-3 gap-x-3 gap-y-2">
                  ...
                  <div className="space-y-2">
                    ...
                    <Labeled label={t('ads.offerDuration')}>{offerDurationLabel}</Labeled>
