...
android {
    namespace = "com.mergespice.alrasmarket"
    ...
    defaultConfig {
        ...
        applicationId = "com.mergespice.alrasmarket"
    ...
    // Avoid downloading Android lint tooling over flaky TLS during release builds.
    lint {
