...
/// Bottom navigation bar for company (supplier) layout.
class CompanyBottomNavBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final navItems = [
      ...
      (
        selectedIcon: AppAssets.blueAddAdsIcon,
        icon: AppAssets.addAdsIcon,
        label: S.of(context).createAds,
        outlinedCircle: false,
        badgeCount: 0,
      ),
      (
...
class CompanyBottomNavItem extends StatelessWidget {
  const CompanyBottomNavItem({
    super.key,
  ...
  Widget build(BuildContext context) {
    ...
    Widget iconWidget = SvgPicture.asset(
      ...
      // Selected add-ad SVG already has blue circle + white plus; filtering
      // flattens both to one color and hides the plus.
      colorFilter: iconPath == AppAssets.blueAddAdsIcon
          ? null
