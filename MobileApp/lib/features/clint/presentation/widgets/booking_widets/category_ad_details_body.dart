...
/// Category / wholesale catalog ad details layout (Purchase Order flow).
class CategoryAdDetailsBody extends StatelessWidget {
  const CategoryAdDetailsBody({
    super.key,
    ...
    if (qty.isNotEmpty) {
      main.add(
        BookingDetailsFactTile(
          ...
          fontFamily: fontFamily,
          value: qty,
          valueColor: BookingDetailsDesign.muted,
        ),
      );
    }
