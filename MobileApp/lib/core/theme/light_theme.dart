...
ThemeData darkTheme(Locale locale) {
  ...
  final base = ThemeData(
    ...
    cardColor: surface,
    hintColor: const Color(0xFF9AA6B8),
    canvasColor: background,
    dividerColor: const Color(0xFF2A3344),
    ...
    textSelectionTheme: const TextSelectionThemeData(
      cursorColor: _defaultAppColor,
      selectionColor: Color(0x553A7DC5),
      selectionHandleColor: _defaultAppColor,
    ),
    inputDecorationTheme: InputDecorationTheme(
      ...
      prefixIconColor: Color(0xFF9AA6B8),
      suffixIconColor: Color(0xFF9AA6B8),
      iconColor: Color(0xFF9AA6B8),
    ),
    progressIndicatorTheme: const ProgressIndicatorThemeData(
      color: _defaultAppColor,
