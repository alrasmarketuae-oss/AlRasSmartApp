...
CREATE TABLE Products (
    ...
    CartAddsCount BIGINT NOT NULL DEFAULT 0,
    FavoritesCount BIGINT NOT NULL DEFAULT 0,
...
CREATE TABLE InternationalShippingPosts (
    ...
    Container20ftPriceUsd DECIMAL(12,2) NULL,
    Container40ftPriceUsd DECIMAL(12,2) NULL,
    CreatedAt DATETIME NOT NULL DEFAULT GETUTCDATE(),
