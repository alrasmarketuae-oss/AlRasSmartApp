...
public static class AdminOrderMapper
{
    ...
    public static AdminOrderListItemDto Map(Order x)
    {
        ...
        return new AdminOrderListItemDto
        {
            ...
            ProductLatitude = product?.Address?.Latitude,
            ProductLongitude = product?.Address?.Longitude,
            VatAed = x.VatAed,
            ...
            DeliveryLatitude = x.DeliveryLatitude ?? x.PendingOrder?.Address?.Latitude,
            DeliveryLongitude = x.DeliveryLongitude ?? x.PendingOrder?.Address?.Longitude,
