...
{
    private const string AllProductsCacheKey = "products:all:v19";
    private const string ProductsByTypeCachePrefix = "products:by-type:v17:";
    private const string ProductsByCategoryCachePrefix = "products:by-category:v12:";
    private const string FeaturedProductsCacheKey = "products:featured:v9";
